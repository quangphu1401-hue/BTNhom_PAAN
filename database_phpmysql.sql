-- =====================================================
-- DATABASE CHO WEBSITE QUẢN LÝ KHÓA HỌC ONLINE
-- Sử dụng với phpMyAdmin
-- =====================================================

-- Bước 1: Tạo database (chạy trước, hoặc tạo thủ công trong phpMyAdmin)
...
-- =====================================================
-- TẠO TÀI KHOẢN ADMIN MẪU (Tùy chọn)
-- Password: admin123 (Bạn NÊN đổi password sau khi đăng nhập)
-- =====================================================
-- Bỏ comment dòng dưới để tạo tài khoản admin
...
-- - 6 bảng (users, categories, courses, enrollments, lessons, materials)
-- - 4 danh mục mẫu trong bảng categories
-- =====================================================
